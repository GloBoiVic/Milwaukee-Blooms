export default function Contact() {
  return (
    <section className="flex flex-col justify-center max-w-screen-xl px-10 my-20 sm:flex-row h-[60vh]">
      <div className="flex flex-col flex-1 sm:items-center text-gray-950 dark:text-slate-50">
