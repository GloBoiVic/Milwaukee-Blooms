function Reviews() {
  return (
    <section>
      <div className="px-4 py-6 bg-white md:px-8 sm:py-8 lg:py-12">
        ...
        <div className="grid max-w-screen-lg grid-cols-1 gap-4 mt-8 md:grid-cols-2 lg:grid-cols-3 ">
          <blockquote>
          ...
          <blockquote>
            ...
            <div className="mt-4">
              <p className="text-2xl font-bold text-purple-500 sm:text-3xl">Blown Away!</p>
